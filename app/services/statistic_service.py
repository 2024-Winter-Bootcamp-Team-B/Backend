...
from Backend.app.models import History
...
class HistoryStat:
    ...
    def add_time(self, start_time : datetime, goal_time: datetime, end_time: datetime):
        ...
        #시간 누적 계산
        self.goal =  f"{goal_hour - start_hour + g_time[0]}:{goal_min - start_min + g_time[1]}"
        self.actual = f"{end_hour - start_hour + a_time[0]}:{end_min - start_min + a_time[1]}"
